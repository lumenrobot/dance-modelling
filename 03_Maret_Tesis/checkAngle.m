function [ArmAngle] = getAngleInverse(RShld,RElbw,RWrst,LShld,LElbw,LWrst)
%% 14 Maret 2014 13:27
...
%% Taruh di Tabel
ArmAngle = [fix(RShldTilt) fix(RShldRotate) ...
			fix(RElbwTilt) fix(RElbwRotate) ...
			fix(LShldTilt) fix(LShldRotate) ...
			fix(LElbwTilt) fix(LElbwRotate)];
