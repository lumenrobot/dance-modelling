...
%
% E 	- observation emission probabilities	= B = nState x mObservation
% P 	- state transition probabilities		= A = nState x nState
...
% E = (0.1*rand(K,num_bins)+ones(K,num_bins))/num_bins;
