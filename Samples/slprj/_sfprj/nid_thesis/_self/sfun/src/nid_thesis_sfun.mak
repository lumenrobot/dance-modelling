...
MACHINE     = nid_thesis
TARGET      = sfun
CHART_SRCS 	= c2_nid_thesis.c
MACHINE_SRC	= nid_thesis_sfun.c
MACHINE_REG = nid_thesis_sfun_registry.c
MAKEFILE    = nid_thesis_sfun.mak
...
OBJLIST_FILE = nid_thesis_sfun.mol
