...
static void initialize_c2_nid_cvst_what_is_nid_modiv
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance);
static void initialize_params_c2_nid_cvst_what_is_nid_modiv
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance);
static void enable_c2_nid_cvst_what_is_nid_modiv
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance);
static void disable_c2_nid_cvst_what_is_nid_modiv
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_nid_cvst_what_is_nid_modiv
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_nid_cvst_what_is_nid_modiv
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance);
static void set_sim_state_c2_nid_cvst_what_is_nid_modiv
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_nid_cvst_what_is_nid_modiv
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance);
static void sf_c2_nid_cvst_what_is_nid_modiv
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance);
static void initSimStructsc2_nid_cvst_what_is_nid_modiv
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance);
static void registerMessagesc2_nid_cvst_what_is_nid_modiv
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_nid_cvst_what_is_nid_modivInstanceStruct *
  chartInstance, const mxArray *c2_RWrst_z, const char_T *c2_identifier);
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_nid_cvst_what_is_nid_modiv, const char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_nid_cvst_what_is_nid_modivInstanceStruct *
  chartInstance);
  ...
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_nid_cvst_what_is_nid_modiv = 0U;
}
  ...
  (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance)
{
  ...
  c2_m_hoistedGlobal = chartInstance->c2_is_active_c2_nid_cvst_what_is_nid_modiv;
   ...
   *c2_st)
{
  ...
  *c2_RWrst_z = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 11)), "RWrst_z");
  chartInstance->c2_is_active_c2_nid_cvst_what_is_nid_modiv =
    c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 12)),
    "is_active_c2_nid_cvst_what_is_nid_modiv");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_nid_cvst_what_is_nid_modiv(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance;
  chartInstance = (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_nid_cvst_what_is_nid_modiv_get_eml_resolved_functions_info
  (void)
{
   ...
   *c2_b_is_active_c2_nid_cvst_what_is_nid_modiv, const char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_nid_cvst_what_is_nid_modiv), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_nid_cvst_what_is_nid_modiv);
  return c2_y;
}
...
void sf_c2_nid_cvst_what_is_nid_modiv_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_nid_cvst_what_is_nid_modiv_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_nid_cvst_what_is_nid_modiv_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_nid_cvst_what_is_nid_modiv(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[15],T\"RWrst_y\",},{M[1],M[16],T\"RWrst_z\",},{M[8],M[0],T\"is_active_c2_nid_cvst_what_is_nid_modiv\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 13, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_nid_cvst_what_is_nid_modiv_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_nid_cvst_what_is_nid_modiv(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_nid_cvst_what_is_nid_modiv
    ((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*) chartInstanceVar);
  initialize_c2_nid_cvst_what_is_nid_modiv
    ((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_nid_cvst_what_is_nid_modiv(void
  *chartInstanceVar)
{
  enable_c2_nid_cvst_what_is_nid_modiv
    ((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_nid_cvst_what_is_nid_modiv(void
  *chartInstanceVar)
{
  disable_c2_nid_cvst_what_is_nid_modiv
    ((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_nid_cvst_what_is_nid_modiv(void
  *chartInstanceVar)
{
  sf_c2_nid_cvst_what_is_nid_modiv
    ((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_nid_cvst_what_is_nid_modiv
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_nid_cvst_what_is_nid_modiv
    ((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_nid_cvst_what_is_nid_modiv();/* state var info */
...
extern void sf_internal_set_sim_state_c2_nid_cvst_what_is_nid_modiv(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_nid_cvst_what_is_nid_modiv
    ((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_nid_cvst_what_is_nid_modiv
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_nid_cvst_what_is_nid_modiv(S);
}

static void sf_opaque_set_sim_state_c2_nid_cvst_what_is_nid_modiv(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_nid_cvst_what_is_nid_modiv(S, st);
}

static void sf_opaque_terminate_c2_nid_cvst_what_is_nid_modiv(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_nid_cvst_what_is_nid_modiv
      ((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_nid_cvst_what_is_nid_modiv
    ((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_nid_cvst_what_is_nid_modiv(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_nid_cvst_what_is_nid_modiv
      ((SFc2_nid_cvst_what_is_nid_modivInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_nid_cvst_what_is_nid_modiv(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_nid_cvst_what_is_nid_modiv(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_nid_cvst_what_is_nid_modiv(SimStruct *S)
{
  SFc2_nid_cvst_what_is_nid_modivInstanceStruct *chartInstance;
  chartInstance = (SFc2_nid_cvst_what_is_nid_modivInstanceStruct *)utMalloc
    (sizeof(SFc2_nid_cvst_what_is_nid_modivInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_nid_cvst_what_is_nid_modivInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_nid_cvst_what_is_nid_modiv;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_nid_cvst_what_is_nid_modiv;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_nid_cvst_what_is_nid_modiv;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_nid_cvst_what_is_nid_modiv;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_nid_cvst_what_is_nid_modiv;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_nid_cvst_what_is_nid_modiv;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_nid_cvst_what_is_nid_modiv;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_nid_cvst_what_is_nid_modiv;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_nid_cvst_what_is_nid_modiv;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_nid_cvst_what_is_nid_modiv;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_nid_cvst_what_is_nid_modiv;
...
void c2_nid_cvst_what_is_nid_modiv_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_nid_cvst_what_is_nid_modiv(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_nid_cvst_what_is_nid_modiv(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_nid_cvst_what_is_nid_modiv(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_nid_cvst_what_is_nid_modiv_method_dispatcher.\n"
