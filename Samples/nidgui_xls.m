...
%% Beres 19 Feb, Update 29 Juni

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear; clc;
trec = 20; 		% Rekaman ke 2,3 icun, 4,5,6 santi
tcapt = 5000; 	% Lama capture kinect
tday = 735787; 	% 07 Juli 2014
CaptImuFile = sprintf('capture_%d_imu.txt',trec);
CaptJntFile = sprintf('capture_%d_joint_S0.xls', trec);
fprintf('=========================================\n');
...
fprintf(' - All data has been saved to xls file :) \n'); pause(1);
